...
if (!function_exists('all_snippets__helper__csv_read_headers__vsh0_0_4')) {
    function all_snippets__helper__csv_read_headers__vsh0_0_4($csv_file, array $expected_headers = []) {
        // --- 1. INPUT VALIDATION --- //
        if (empty($csv_file)) {
            return null;
        }
        if (!file_exists($csv_file) && function_exists('all_snippets__helper__create_required_resources__vsh0_0_4')) {
            all_snippets__helper__create_required_resources__vsh0_0_4();
        }
