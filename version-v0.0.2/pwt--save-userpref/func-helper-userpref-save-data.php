...
function all_snippets__helper__userpref_save_data__vsh0_0_2($plugin_slug, $user_id, $user_preferences, $page_slug) {
    ...
    $result = all_snippets__helper__update_option__vsh0_0_2([
