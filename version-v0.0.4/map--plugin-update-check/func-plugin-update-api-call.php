...
if (!has_filter('pre_set_site_transient_update_plugins', 'all_snippets__hook__update_check_updates__vsh0_0_4')) {
    add_filter('pre_set_site_transient_update_plugins', 'all_snippets__hook__update_check_updates__vsh0_0_4', 10, 1);
}

function all_snippets__hook__update_check_updates__vsh0_0_4($transient) {
