...
add_action('admin_notices', 'all_snippets__hook__cache_admin_notices__vsh0_0_4');
if (!function_exists('all_snippets__hook__cache_admin_notices__vsh0_0_4')) {
    // Ta funkcija se izvede na 'admin_notices' hooku
    function all_snippets__hook__cache_admin_notices__vsh0_0_4() {
