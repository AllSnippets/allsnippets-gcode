...
add_action('admin_init', 'all_snippets__hook__maintenance_check__vsh0_0_4', 1);
if (!function_exists('all_snippets__hook__maintenance_check__vsh0_0_4')) {
    function all_snippets__hook__maintenance_check__vsh0_0_4() {
        // Samo 1x na request
        ...
        // Helperji za bazo
        $get_transient_func = 'all_snippets__helper__get_transient__vsh0_0_4';
        $set_transient_func = 'all_snippets__helper__set_transient__vsh0_0_4';
