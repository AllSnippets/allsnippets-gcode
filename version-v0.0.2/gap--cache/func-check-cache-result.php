...
if (!function_exists('all_snippets__helper__cache_results__vsh0_0_2')) {
    ...
    function all_snippets__helper__cache_results__vsh0_0_2() {
        ...
        // Helperji za bazo
        $get_option_func = 'all_snippets__helper__get_option__vsh0_0_2';
...
if (!function_exists('all_snippets__helper__check_cache_result__vsh0_0_2')) {
    /**
     * Vrne status cache-a za določen vtičnik.
     */
    function all_snippets__helper__check_cache_result__vsh0_0_2($slug) {
        global $all_snippets_status_cache;

        // Če cache še ni bil naložen, ga naložimo zdaj
        if (empty($all_snippets_status_cache)) {
            all_snippets__helper__cache_results__vsh0_0_2();
        }
