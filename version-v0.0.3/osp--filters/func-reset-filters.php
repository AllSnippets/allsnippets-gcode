...
add_action('wp_ajax_all_snippets__ajax__reset_filters__vsh0_0_3', 'all_snippets__ajaxfunc__reset_filters__vsh0_0_3');
function all_snippets__ajaxfunc__reset_filters__vsh0_0_3() {
    // --- 1. SECURITY CHECK --- //
    ...
    $delete_result = all_snippets__helper__delete_option__vsh0_0_3([
