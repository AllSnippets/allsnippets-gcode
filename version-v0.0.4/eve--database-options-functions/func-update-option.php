...
if (!function_exists('all_snippets__helper__update_option__vsh0_0_4')) {
    function all_snippets__helper__update_option__vsh0_0_4($args) {
        global $wpdb;
        ...
        if ($wpdb->get_var("SHOW TABLES LIKE '$table_name'") !== $table_name) {
            all_snippets__helper__create_options_table__vsh0_0_4();
        }
