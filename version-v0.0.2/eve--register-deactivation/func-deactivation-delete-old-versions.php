...
if (!function_exists('all_snippets__helper__on_deactivation_delete_old_versions__vsh0_0_2')) {
    // Dodamo parameter, da vemo, kateri vtičnik se deaktivira (in ga ne upoštevamo kot aktivnega)
    function all_snippets__helper__on_deactivation_delete_old_versions__vsh0_0_2($deactivating_plugin_file = null) {
        // --- 1. SECURITY & INIT --- //
