...
if (!function_exists('all_snippets__helper__check_shared_files_existence__vsh0_0_3')) {
    function all_snippets__helper__check_shared_files_existence__vsh0_0_3($plugin_prefix, $plugin_pages = []) {
        ...
        $check_missing = function() use ($plugin_prefix, $page) {
            ...
            $checks = [
                ['.php', all_snippets__helper__get_effective_shared_list__vsh0_0_3($plugin_prefix, '__LIST__SHARED_PHP', $page)],
                ['.js', all_snippets__helper__get_effective_shared_list__vsh0_0_3($plugin_prefix, '__LIST__SHARED_JS', $page)],
                // Pri core JS moramo iz arraya objektov dobiti samo slug (ime datoteke)
                ['.js', array_column(all_snippets__helper__get_effective_shared_list__vsh0_0_3($plugin_prefix, '__LIST__SHARED_CORE_JS', $page), 'slug')],
                ['.css', all_snippets__helper__get_effective_shared_list__vsh0_0_3($plugin_prefix, '__LIST__SHARED_CSS', $page), 'css-styles/']
            ];
