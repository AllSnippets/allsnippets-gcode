...
add_action('wp_ajax_all_snippets__ajax__save_userpref_admin_page__vsh0_0_4', 'all_snippets__ajaxfunc__save_userpref_admin_page__vsh0_0_4');
function all_snippets__ajaxfunc__save_userpref_admin_page__vsh0_0_4() {
    // --- 1. SECURITY CHECK --- //
    ...
    $helper_get_func = 'all_snippets__helper__userpref_get_data__vsh0_0_4';
    $helper_save_func = 'all_snippets__helper__userpref_save_data__vsh0_0_4';
