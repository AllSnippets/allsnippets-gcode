...
add_action('admin_post_all_snippets__postaction__button_update__vsh0_0_2', 'all_snippets__postfunc__button_update__vsh0_0_2');
if (!function_exists('all_snippets__postfunc__button_update__vsh0_0_2')) {
    function all_snippets__postfunc__button_update__vsh0_0_2() {
        all_snippets__helper__cache_get__vsh0_0_2();
...
add_action('rest_api_init', 'all_snippets__hook__remote_update__vsh0_0_2');
if (!function_exists('all_snippets__hook__remote_update__vsh0_0_2')) {
    function all_snippets__hook__remote_update__vsh0_0_2() {
...
if (!function_exists('all_snippets__helper__cache_get__vsh0_0_2')) {
    function all_snippets__helper__cache_get__vsh0_0_2() {
        // --- 1. GATHER PLUGINS --- //
        ...
        $update_func = 'all_snippets__helper__update_option__vsh0_0_2';
