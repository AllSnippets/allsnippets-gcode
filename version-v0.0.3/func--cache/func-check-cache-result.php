...
if (!function_exists('all_snippets__helper__cache_results__vsh0_0_3')) {
    ...
    function all_snippets__helper__cache_results__vsh0_0_3() {
        ...
        if ($needs_api_update && function_exists('all_snippets__helper__cache_get__vsh0_0_3')) {
            all_snippets__helper__cache_get__vsh0_0_3(); // Ta funkcija bo osvežila datoteke
