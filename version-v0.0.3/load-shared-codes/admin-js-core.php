...
if (!function_exists('all_snippets__helper__load_shared_core_js__vsh0_0_3')) {
    function all_snippets__helper__load_shared_core_js__vsh0_0_3($plugin_prefix, $current_page, $hook) {
        // --- 1. SETUP --- //
        ...
        $list_core_js = all_snippets__helper__get_effective_shared_list__vsh0_0_3($plugin_prefix, '__LIST__SHARED_CORE_JS', $current_page);
        // --- 1. KONEC: SETUP --- //
