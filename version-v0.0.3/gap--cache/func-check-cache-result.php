...
if (!function_exists('all_snippets__helper__cache_results__vsh0_0_3')) {
    ...
    function all_snippets__helper__cache_results__vsh0_0_3() {
        global $all_snippets_status_cache;
...
if (!function_exists('all_snippets__helper__check_cache_result__vsh0_0_3')) {
    /**
     * Vrne status cache-a za določen vtičnik.
     */
    function all_snippets__helper__check_cache_result__vsh0_0_3($slug) {
        global $all_snippets_status_cache;
