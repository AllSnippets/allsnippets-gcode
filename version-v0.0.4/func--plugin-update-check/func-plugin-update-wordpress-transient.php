...
if (!has_filter('plugins_api', 'all_snippets__hook__update_plugin_info__vsh0_0_4')) {
    add_filter('plugins_api', 'all_snippets__hook__update_plugin_info__vsh0_0_4', 20, 3);
}

function all_snippets__hook__update_plugin_info__vsh0_0_4($result, $action, $args) {
    // --- 1. VALIDATION --- //
