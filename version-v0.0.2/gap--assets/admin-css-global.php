...
if (!function_exists('all_snippets__helper__load_shared_global_css__vsh0_0_2')) {
    function all_snippets__helper__load_shared_global_css__vsh0_0_2($plugin_prefix, $files = null) {
