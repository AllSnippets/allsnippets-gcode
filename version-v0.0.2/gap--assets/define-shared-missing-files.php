...
if (!function_exists('all_snippets__helper__check_shared_files_existence__vsh0_0_2')) {
    function all_snippets__helper__check_shared_files_existence__vsh0_0_2($plugin_prefix, $plugin_pages = []) {
        ...
        $check_missing = function() use ($plugin_prefix, $page_for_filter) {
            ...
            $checks = [
                ['.php', all_snippets__helper__get_effective_shared_list__vsh0_0_2($plugin_prefix, '__LIST__SHARED_PHP', $page_for_filter)],
                ['.js', all_snippets__helper__get_effective_shared_list__vsh0_0_2($plugin_prefix, '__LIST__SHARED_JS', $page_for_filter)],
                // Pri core JS moramo iz arraya objektov dobiti samo slug (ime datoteke)
                ['.js', array_column(all_snippets__helper__get_effective_shared_list__vsh0_0_2($plugin_prefix, '__LIST__SHARED_CORE_JS', $page_for_filter), 'slug')],
                ['.css', all_snippets__helper__get_effective_shared_list__vsh0_0_2($plugin_prefix, '__LIST__SHARED_CSS', $page_for_filter), 'css-styles/']
            ];
        ...
        if ($check_missing()) {
            ...
            if (function_exists('all_snippets__helper__dowload_shared_files__vsh0_0_2')) {
                all_snippets__helper__dowload_shared_files__vsh0_0_2();
            }
