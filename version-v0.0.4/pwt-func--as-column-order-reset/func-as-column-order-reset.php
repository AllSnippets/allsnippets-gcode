...
add_action('wp_ajax_all_snippets__ajax__reset_column_order__vsh0_0_4', 'all_snippets__ajaxfunc__reset_column_order__vsh0_0_4');
function all_snippets__ajaxfunc__reset_column_order__vsh0_0_4() {
    // --- 1. SECURITY CHECK --- //
