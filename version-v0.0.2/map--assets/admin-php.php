...
if (!function_exists('all_snippets__helper__load_shared_php__vsh0_0_2')) {
    function all_snippets__helper__load_shared_php__vsh0_0_2($plugin_prefix, $current_page) {
        // --- 1. SETUP --- //
        ...
        $list_php = all_snippets__helper__get_effective_shared_list__vsh0_0_2($plugin_prefix, '__LIST__SHARED_PHP', $current_page);
        // --- 1. KONEC: SETUP --- //
